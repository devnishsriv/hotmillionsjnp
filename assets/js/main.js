...
const menuItems = [
  { name: 'Classic Butterscotch Cake', category: 'Cakes', price: '₹500+', desc: 'Our legendary butterscotch cake. Butter-cream layers studded with premium crunchy nougat.', tag: 'Best Seller', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b?auto=format&fit=crop&w=600&q=80' },
  { name: 'Elegant Vanilla Dream Cake', category: 'Cakes', price: '₹400+', desc: 'Soft and fluffy layers of vanilla sponge layered with pure real vanilla bean cream.', tag: 'Classic', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&w=600&q=80' },
  { name: 'Decadent Chocolate Truffle', category: 'Cakes', price: '₹500+', desc: 'Rich chocolate sponge cake smothered in fine dark chocolate ganache glaze.', tag: 'Popular', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=600&q=80' },
  { name: 'Luxe Multi-Tier Wedding Cake', category: 'Cakes', price: '₹2,000+', desc: 'Bespoke design wedding cake tailored for your special day. Tiered structure with customized toppers.', tag: 'Signature', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1562440499-64c9a111f713?auto=format&fit=crop&w=800&q=80' },
  { name: 'Custom Theme Birthday Cake', category: 'Cakes', price: '₹600+', desc: 'Artistic fondant or whipped cream themed cake with characters, colors, and toys of your choice.', tag: 'Trending', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1558301211-0d8c8ddee6ec?auto=format&fit=crop&w=600&q=80' },
  { name: 'Royal Red Velvet Cake', category: 'Cakes', price: '₹700+', desc: 'Exquisite red velvet sponge layered with smooth and tangy cream-cheese frosting.', tag: 'Premium', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1586788680434-30d324b2d46f?auto=format&fit=crop&w=600&q=80' },
  { name: 'Tropical Pineapple Sunshine Cake', category: 'Cakes', price: '₹450+', desc: 'Fresh whipped cream cake layered with juicy sweet pineapple pieces and cherries.', tag: 'Fresh', icon: 'mdi:cake-variant', img: 'https://images.unsplash.com/photo-1535254973040-607b474cb50d?auto=format&fit=crop&w=600&q=80' },
  
  { name: 'Fresh Butterscotch Pastry', category: 'Pastries', price: '₹80+', desc: 'Single-serve slice of our legendary buttery nougat butterscotch masterpiece.', tag: 'Fresh Batch', icon: 'mdi:cookie', img: 'https://images.unsplash.com/photo-1519869325930-281384150729?auto=format&fit=crop&w=600&q=80' },
  { name: 'Vanilla Cream Pastry', category: 'Pastries', price: '₹70+', desc: 'Light, delicate slice of sponge filled with premium cream and fruit bits.', tag: 'Classic', icon: 'mdi:cookie', img: 'https://images.unsplash.com/photo-1571115177098-24ec42ed204d?auto=format&fit=crop&w=600&q=80' },
  { name: 'Double Chocolate Fudge Pastry', category: 'Pastries', price: '₹80+', desc: 'A rich and chocolatey slice packed with premium melted fudge chips.', tag: 'Chocolatey', icon: 'mdi:cookie', img: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=600&q=80' },
  { name: 'Black Forest Pastry', category: 'Pastries', price: '₹90+', desc: 'Traditional German slice layered with cherries, rich cream, and dark chocolate flakes.', tag: 'Beloved', icon: 'mdi:cookie', img: 'https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?auto=format&fit=crop&w=600&q=80' },
  
  { name: 'Artisan Assorted Chocolates', category: 'Chocolates', price: '₹200+', desc: 'A custom assortment of dark, milk, and white chocolates hand-tempered on site.', tag: 'Gift Idea', icon: 'mdi:candy', img: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?auto=format&fit=crop&w=600&q=80' },
  { name: 'Gourmet Handcrafted Truffles', category: 'Chocolates', price: '₹300+', desc: 'Premium ganache centers rolled in cocoa powder, roasted nuts, or colorful sprinkles.', tag: 'Artisan', icon: 'mdi:candy', img: 'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?auto=format&fit=crop&w=600&q=80' },
  { name: 'Premium Chocolate Gift Box', category: 'Chocolates', price: '₹500+', desc: 'Luxury golden gift packaging loaded with 16 signature handcrafted pralines.', tag: 'Gifting Special', icon: 'mdi:gift', img: 'https://images.unsplash.com/photo-1526081347589-7fa3cb41b4b2?auto=format&fit=crop&w=600&q=80' },
  
  { name: 'Fresh Mozzarella Cheese', category: 'Savory', price: '₹250+', desc: 'Our famous house-prepared Italian mozzarella. Super soft, fresh, and perfect for melting.', tag: 'Local Pride', icon: 'mdi:cheese', img: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?auto=format&fit=crop&w=600&q=80' },
  { name: 'Hot Mozzarella Cheese Pizza', category: 'Savory', price: '₹100+', desc: 'Golden, bubbly pan pizza topped with our signature fresh local cheese and tangy tomato sauce.', tag: 'Fresh Baked', icon: 'mdi:pizza', img: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=600&q=80' },
  { name: 'Crispy Veg Puff Patties', category: 'Savory', price: '₹30+', desc: 'Warm flaky puff pastry shell stuffed with spicy mashed potato, green peas and herbs.', tag: 'Snack King', icon: 'mdi:food-variant', img: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=600&q=80' },
  { name: 'Crispy Paneer Puff Patties', category: 'Savory', price: '₹40+', desc: 'Rich golden puff pastry containing seasoned spiced paneer cubes.', tag: 'Spicy Delight', icon: 'mdi:food-variant', img: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=600&q=80' },
  { name: 'Artisan Milk Bread Slices', category: 'Savory', price: '₹30+', desc: 'Freshly baked super-soft loaf sliced and prepared daily. Zero preservatives.', tag: 'Daily Fresh', icon: 'mdi:bread-slice', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=600&q=80' }
];
      ...
      <div class="bg-white rounded-3xl border border-brand-100 shadow-xl shadow-brand-500/5 p-4 flex flex-col justify-between group specialty-card hover:-translate-y-2 transition-all duration-300">
        <div>
          <div class="relative rounded-2xl overflow-hidden aspect-[4/3] mb-4 bg-brand-50">
            <img src="${item.img || 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=600&q=80'}" referrerpolicy="no-referrer" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="${item.name}">
